            ...
            <View style={styles.content}>
                ...
                <View style={styles.card}>
                    <View style={styles.rowBetween}>
                        ...
                        <View style={[styles.statusBadge, order.status === 'Delivered' ? styles.deliveredBadge : styles.pendingBadge]}>
                            <Text style={[styles.statusText, order.status === 'Delivered' ? styles.deliveredText : styles.pendingText]}>
                                {order.status}
                            </Text>
                        </View>
                    </View>
                ...
                <View style={[styles.card, styles.highlightCard]}>
                    ...
                    <View style={styles.trainRow}>
                        ...
                        <Text style={styles.trainNumber}>{order.trainNumber} - {order.trainName}</Text>
                    </View>
